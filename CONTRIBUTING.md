# Contributing to the xchange library


The _xchange_ library is for everyone. And, it is developers like you who can make it better. Whether there is a 
...
open (and closed) [Issues](https://github.com/Sigmyne/xchange/issues). If an existing issue seems like a 
...
[Discussions](https://github.com/Sigmyne/xchange/discussions).
