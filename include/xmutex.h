...
#  define xmut_init           pthread_mutex_init        ///< initialize mutex (not return)
...
#  define xmut_init           mtx_init                  ///< initialize mutex (not return)
...
#  define xmut_init(x, t)     InitializeSRWLock(x)      ///< initialize mutex (not return)
#  define xmut_lock           AcquireSRWLockExclusive   ///< lock mutex
#  define xmut_unlock         ReleaseSRWLockExclusive   ///< unlock mutex
#  define xmut_destroy        (void)                    ///< destroy mutex
#  define THREAD_SAFE         1                         ///< mutexes may be used
